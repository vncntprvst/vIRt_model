sval = scan_val()
sval.scan_type = 'y'
sval.parname = ["netpar.Tper_syn_ext"]
...
syncoupparI1I1.syn_receptor_par_ar[1].gsyn = 12.0
...
syncoupparI1I2.syn_receptor_par_ar[1].gsyn = 20.0
#syncoupparI1I2.gel = 0.0

#IRT2 <- IRT1
syncoupparI2I1 = deepcopy(syncoupparI1I2)
syncoupparI2I1.syn_receptor_par_ar[1].gsyn = 20.0
#syncoupparI2I1.gel = 0.0

#IRT2 <- IRT2
syncoupparI2I2 = deepcopy(syncoupparI1I1)
syncoupparI2I2.syn_receptor_par_ar[1].gsyn = 12.0
...
netpar.Trand_syn_ext = 70.0
netpar.Tup_syn_ext = 20.0
...
runpar.nwrite=[[1, 8],  #I1
	       ...
	       [1]]     #F
runpar.twrite = 2
runpar.tmcol = 70000.0
runpar.tstat = 59000.0
runpar.traster = 60000.0
runpar.ion_trj = 1
