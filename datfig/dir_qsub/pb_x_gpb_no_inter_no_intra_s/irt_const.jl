sval = scan_val()
sval.scan_type = 'y'
sval.parname = ["cellparI1.gsyn_ext"]
...
syncoupparI1I1.syn_receptor_par_ar[1].gsyn = 0.0
...
syncoupparI1I2.syn_receptor_par_ar[1].gsyn = 0.0
#syncoupparI1I2.gel = 0.0

#IRT2 <- IRT1
syncoupparI2I1 = deepcopy(syncoupparI1I2)
syncoupparI2I1.syn_receptor_par_ar[1].gsyn = 0.0
#syncoupparI2I1.gel = 0.0

#IRT2 <- IRT2
syncoupparI2I2 = deepcopy(syncoupparI1I1)
syncoupparI2I2.syn_receptor_par_ar[1].gsyn = 0.0
#syncoupparI2I2.gel = 0.0

#FN <- IRT1
syncoupparFI1 = deepcopy(syncoupparI1I1)

syncoupparFI1.syn_receptor_par_ar[1].gsyn = 1.0
